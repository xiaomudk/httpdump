...
func main() {
	...
	flag.StringVar(&o.OutputFormat, "output-format", "", "Output format: curl: an equivalent curl command for each http request, json: json format, default: Normal format")
